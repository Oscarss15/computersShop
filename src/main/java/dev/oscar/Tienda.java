...
public class Tienda {
    ...
    public void eliminarComputador(String marca) {
        ...
        System.out.println("No se ha encontrado el computador con  la marca " + marca );
    }
    ...
    public void listarComputadores() {
        if (computadores.isEmpty()) {
            System.out.println("No hay ningún computador en la tienda.");
        } else {
            System.out.println("Lista de computadores que hay en la tienda:");
            for (Computador computador : computadores) {
